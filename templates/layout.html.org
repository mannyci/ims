    ...
    <div class="sidebar" data-color="white" data-active-color="danger">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li id="envNav">
            <a data-toggle="collapse" href="#env" class="collapsed" aria-expanded="false">
            ...
            <div class="collapse" id="env" style="">
              <ul class="nav">
                <li>
                  <a href="{% url 'ui:newenv' %}">
                    <span class="sidebar-mini-icon">N</span>
                    <span class="sidebar-normal"> New </span>
                  </a>
                </li>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item" data-toggle="tooltip" data-placement="bottom" title="Admin">
                <a class="nav-link btn-rotate" href="{% url 'admin:index' %}">
                  ...
                  <p>
                    <span class="d-lg-none d-md-block">{{ user.get_role }}</span>
                  </p>
                </a>
              </li>
              {% endif %}
...
$('#minimizeSidebar').click(function (e) {
  ...
  if (toggleState == 'closed'){
    ...
    localStorage.setItem("toggleState", "open");
  } else {
