...
from core.views import HostCreate, HostList, HostDetail, HostEdit, HostDelete, EnvNew, EnvList, EnvUpdate, HostGroupNew
...
urlpatterns = [
    ...
    url(r'^host/(?P<name>[\w-]+)$', view=HostDetail.as_view(), name='hostdetail'),
    url(r'^host/edit/(?P<name>[\w-]+)$', view=HostEdit.as_view(), name='hostedit'),
